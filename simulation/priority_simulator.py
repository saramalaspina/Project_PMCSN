...
count_C = 0 # number of type E departed jobs
...
queue_edge_E = 0  # variable to track type E jobs waiting at the edge node
queue_edge_C = 0  # variable to track type C jobs waiting at the edge node
